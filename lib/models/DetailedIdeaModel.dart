class DetailedIdeaModel {
  String message;
  int status;
  int success;
  Data data;

  DetailedIdeaModel({this.message, this.status, this.success, this.data});

  DetailedIdeaModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['modified_at'] = this.modifiedAt.toString();
    return data;
  }
}
